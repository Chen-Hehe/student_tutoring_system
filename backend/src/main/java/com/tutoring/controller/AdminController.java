...
public class AdminController {
    ...
    public Result<Map<String, Object>> getStatistics() {
        try {
            long teacherCount = teacherRepository.selectCount(new LambdaQueryWrapper<Teacher>().eq(Teacher::getDeleted, 0));
            long studentCount = studentRepository.selectCount(new LambdaQueryWrapper<Student>().eq(Student::getDeleted, 0));
            long parentCount = parentRepository.selectCount(new LambdaQueryWrapper<Parent>().eq(Parent::getDeleted, 0));
            long chatCount = chatRecordRepository.selectCount(new LambdaQueryWrapper<ChatRecord>().eq(ChatRecord::getDeleted, 0));
