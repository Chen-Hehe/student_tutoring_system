...
INSERT INTO `learning_resources` VALUES (6, '初中数学几何证明技巧', '详细讲解几何证明的方法和技巧', 'courseware', 'http://example.com/geometry', 1001, '数学', '2026-04-22 10:23:38', 0, 1, NULL, NULL);
...
INSERT INTO `learning_resources` VALUES (13, '四年级数学应用题专项训练', '四年级数学常见应用题类型与解题方法汇总', 'courseware', 'http://example.com/math4', 1001, '数学', '2026-04-23 12:53:08', 0, 0, NULL, NULL);
INSERT INTO `learning_resources` VALUES (14, '初中语文文言文实词解析', '初中文言文常见实词用法与例句讲解', 'courseware', 'http://example.com/chinese_classic', 1001, '语文', '2026-04-23 12:53:08', 0, 0, NULL, NULL);
INSERT INTO `learning_resources` VALUES (15, '高中数学函数单调性专题', '高中数学函数单调性判断与应用技巧', 'courseware', 'http://example.com/math_function', 1001, '数学', '2026-04-23 12:53:08', 0, 0, NULL, NULL);
INSERT INTO `learning_resources` VALUES (16, '三年级语文看图写话教学视频', '三年级看图写话步骤与技巧讲解', 'video', 'http://example.com/writing3', 1002, '语文', '2026-04-23 12:53:08', 0, 0, NULL, NULL);
INSERT INTO `learning_resources` VALUES (17, '初中物理电路分析教案', '初中物理串并联电路分析与实验设计教案', 'lesson_plan', 'http://example.com/physics_circuit', 1002, '物理', '2026-04-23 12:53:08', 0, 0, NULL, NULL);
INSERT INTO `learning_resources` VALUES (18, '高中语文现代文阅读答题模板', '高中现代文阅读题型与答题思路总结', 'video', 'http://example.com/reading_modern', 1002, '语文', '2026-04-23 12:53:08', 0, 0, NULL, NULL);
...
-- ----------------------------
INSERT INTO `psychological_assessment_details` VALUES (9, 28, '情绪稳定性', 90, 'good', '2026-04-23 19:53:52', '2026-04-23 19:53:52', 0);
INSERT INTO `psychological_assessment_details` VALUES (10, 28, '学习压力', 90, 'good', '2026-04-23 19:53:52', '2026-04-23 19:53:52', 0);
INSERT INTO `psychological_assessment_details` VALUES (11, 28, '社交互动', 90, 'good', '2026-04-23 19:53:52', '2026-04-23 19:53:52', 0);
INSERT INTO `psychological_assessment_details` VALUES (12, 28, '自我认知', 90, 'good', '2026-04-23 19:53:52', '2026-04-23 19:53:52', 0);
INSERT INTO `psychological_assessment_details` VALUES (13, 29, '情绪稳定性', 75, 'warning', '2026-04-23 20:26:28', '2026-04-23 20:26:28', 0);
INSERT INTO `psychological_assessment_details` VALUES (14, 29, '学习压力', 75, 'warning', '2026-04-23 20:26:28', '2026-04-23 20:26:28', 0);
INSERT INTO `psychological_assessment_details` VALUES (15, 29, '社交互动', 90, 'good', '2026-04-23 20:26:28', '2026-04-23 20:26:28', 0);
INSERT INTO `psychological_assessment_details` VALUES (16, 29, '自我认知', 90, 'good', '2026-04-23 20:26:28', '2026-04-23 20:26:28', 0);
INSERT INTO `psychological_assessment_details` VALUES (17, 30, '情绪稳定性', 75, 'warning', '2026-04-23 20:27:14', '2026-04-23 20:27:14', 0);
INSERT INTO `psychological_assessment_details` VALUES (18, 30, '学习压力', 75, 'warning', '2026-04-23 20:27:14', '2026-04-23 20:27:14', 0);
INSERT INTO `psychological_assessment_details` VALUES (19, 30, '社交互动', 60, 'warning', '2026-04-23 20:27:14', '2026-04-23 20:27:14', 0);
INSERT INTO `psychological_assessment_details` VALUES (20, 30, '自我认知', 90, 'good', '2026-04-23 20:27:14', '2026-04-23 20:27:14', 0);
INSERT INTO `psychological_assessment_details` VALUES (21, 31, '情绪稳定性', 90, 'good', '2026-04-23 20:38:12', '2026-04-23 20:38:12', 0);
INSERT INTO `psychological_assessment_details` VALUES (22, 31, '学习压力', 45, 'danger', '2026-04-23 20:38:12', '2026-04-23 20:38:12', 0);
INSERT INTO `psychological_assessment_details` VALUES (23, 31, '社交互动', 90, 'good', '2026-04-23 20:38:12', '2026-04-23 20:38:12', 0);
INSERT INTO `psychological_assessment_details` VALUES (24, 31, '自我认知', 90, 'good', '2026-04-23 20:38:12', '2026-04-23 20:38:12', 0);
INSERT INTO `psychological_assessment_details` VALUES (25, 32, '情绪稳定性', 75, 'warning', '2026-04-23 20:41:06', '2026-04-23 20:41:06', 0);
INSERT INTO `psychological_assessment_details` VALUES (26, 32, '学习压力', 60, 'warning', '2026-04-23 20:41:06', '2026-04-23 20:41:06', 0);
INSERT INTO `psychological_assessment_details` VALUES (27, 32, '社交互动', 90, 'good', '2026-04-23 20:41:06', '2026-04-23 20:41:06', 0);
INSERT INTO `psychological_assessment_details` VALUES (28, 32, '自我认知', 90, 'good', '2026-04-23 20:41:06', '2026-04-23 20:41:06', 0);
...
CREATE TABLE `psychological_assessments`  (
  ...
  `assess_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted` tinyint NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `student_id`(`student_id` ASC) USING BTREE,
...
-- ----------------------------
INSERT INTO `psychological_assessments` VALUES (17, 3001, 1001, '2026-04-23 19:16:01', 100, '非常好，继续保持', NULL, 'teacher_professional', '2026-04-23 19:16:01', 0);
INSERT INTO `psychological_assessments` VALUES (28, 3001, 2001, '2026-04-23 19:53:52', 90, '', NULL, 'student_self', '2026-04-23 19:53:52', 0);
INSERT INTO `psychological_assessments` VALUES (29, 3003, 2003, '2026-04-23 20:26:28', 83, '', NULL, 'student_self', '2026-04-23 20:26:28', 0);
INSERT INTO `psychological_assessments` VALUES (30, 3003, 1001, '2026-04-23 20:27:14', 100, '要多和其他同学接触，保持好心情', NULL, 'teacher_professional', '2026-04-23 20:27:14', 0);
INSERT INTO `psychological_assessments` VALUES (31, 3002, 2002, '2026-04-23 20:38:11', 79, '', NULL, 'student_self', '2026-04-23 20:38:11', 0);
INSERT INTO `psychological_assessments` VALUES (32, 3002, 1001, '2026-04-23 20:41:06', 70, '该生对学习上的压力难以自己疏导，家长需要关注一下，排解一下在学习上的问题，老师这边也会进行一个关注和重视', NULL, 'teacher_professional', '2026-04-23 20:41:06', 0);
...
CREATE TABLE `psychological_statuses`  (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` tinyint NULL DEFAULT 0,
  `assess_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT 'student_self',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `student_id`(`student_id` ASC) USING BTREE,
...
-- ----------------------------
INSERT INTO `psychological_statuses` VALUES (1, 3001, '良好', 'good', 85, '优秀', 'good', 90, '中等', 'warning', 60, '良好', 'good', 80, '2026-04-20 21:17:33', '2026-04-20 21:17:33', 0, 'student_self');
INSERT INTO `psychological_statuses` VALUES (3, 3001, '优秀', 'good', 90, '优秀', 'good', 90, '优秀', 'good', 90, '优秀', 'good', 90, '2026-04-23 18:28:29', '2026-04-23 18:28:29', 0, 'student_self');
INSERT INTO `psychological_statuses` VALUES (4, 3001, '优秀', 'good', 90, '优秀', 'good', 90, '优秀', 'good', 90, '优秀', 'good', 90, '2026-04-23 18:30:56', '2026-04-23 18:30:56', 0, 'student_self');
INSERT INTO `psychological_statuses` VALUES (5, 3001, '优秀', 'good', 90, '优秀', 'good', 90, '优秀', 'good', 90, '优秀', 'good', 90, '2026-04-23 18:51:44', '2026-04-23 18:51:44', 0, 'student_self');
INSERT INTO `psychological_statuses` VALUES (6, 3001, '优秀', 'good', 90, '优秀', 'good', 90, '优秀', 'good', 90, '优秀', 'good', 90, '2026-04-23 19:16:02', '2026-04-23 20:10:11', 0, 'teacher_professional');
INSERT INTO `psychological_statuses` VALUES (7, 3001, '优秀', 'good', 90, '优秀', 'good', 90, '优秀', 'good', 90, '优秀', 'good', 90, '2026-04-23 19:16:24', '2026-04-23 19:16:24', 0, 'student_self');
INSERT INTO `psychological_statuses` VALUES (8, 3001, '优秀', 'good', 90, '优秀', 'good', 90, '优秀', 'good', 90, '优秀', 'good', 90, '2026-04-23 19:53:53', '2026-04-23 19:53:53', 0, 'student_self');
INSERT INTO `psychological_statuses` VALUES (9, 3003, '良好', 'warning', 75, '优秀', 'good', 90, '良好', 'warning', 75, '优秀', 'good', 90, '2026-04-23 20:26:28', '2026-04-23 20:26:28', 0, 'student_self');
INSERT INTO `psychological_statuses` VALUES (10, 3003, '良好', 'warning', 75, '良好', 'warning', 60, '良好', 'warning', 75, '优秀', 'good', 90, '2026-04-23 20:27:14', '2026-04-23 20:27:14', 0, 'teacher_professional');
INSERT INTO `psychological_statuses` VALUES (11, 3002, '优秀', 'good', 90, '优秀', 'good', 90, '需关注', 'danger', 45, '优秀', 'good', 90, '2026-04-23 20:38:12', '2026-04-23 20:38:12', 0, 'student_self');
INSERT INTO `psychological_statuses` VALUES (12, 3002, '良好', 'warning', 75, '优秀', 'good', 90, '良好', 'warning', 60, '优秀', 'good', 90, '2026-04-23 20:41:06', '2026-04-23 20:41:06', 0, 'teacher_professional');
